...
- Refactor Format class to align with the Format class of @itwin/ecschema-metadata.
...
- Update test provider to use CUB_YRD not CUB_YD. Change to use findUnitByName instead of FindUnit.
...
- Add ability to define custom quantity formatting props.
...
- Fix quantity formatting bug for composite formats when precision is set low.
...
- Fix formatting bug when low precision is defined in format.
...
- Add API tags to classes, interfaces, and enums as appropriate.
