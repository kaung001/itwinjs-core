...
- promote webgl-compatibility API to public.
...
- Detect Intel HD 620/630 driver bug.
...
- Detect buggy Intel drivers that can produce transparency anomalies.
...
- Fix WebGL context loss when resizing a window on Safari 14.
...
- webgl2 now considered an optional feature
...
- Added maxSamples for antialiasing
- WebglRenderCompatiblityInfo now includes context used for generating it
